...
#
# Script generated by Vivado on Wed Oct 01 11:38:44 -0400 2025
...
export RDI_DATADIR="R:/fpga/xillinix/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot  xil_defaultlib. xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="R:/fpga/xillinix/Vivado/2024.2/data/xsim"
  fi
