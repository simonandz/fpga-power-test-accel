...
HD_PWD='R:/fpga/fpga-power-test-accel/build/mlp_benchmark/mlp_benchmark.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mlp_top.tcl
