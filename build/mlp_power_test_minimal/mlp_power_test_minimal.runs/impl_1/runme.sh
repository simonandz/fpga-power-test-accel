...
HD_PWD='R:/fpga/fpga-power-test-accel/build/mlp_power_test_minimal/mlp_power_test_minimal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_power_test_wrapper_minimal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mlp_power_test_wrapper_minimal.tcl -notrace
