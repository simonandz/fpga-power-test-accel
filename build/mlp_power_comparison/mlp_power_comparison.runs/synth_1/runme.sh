...
HD_PWD='R:/fpga/fpga-power-test-accel/build/mlp_power_comparison/mlp_power_comparison.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_power_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mlp_power_test_wrapper.tcl
