...
HD_PWD='R:/fpga/fpga-power-test-accel/build/mlp_debug/mlp_debug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_top_debug_memtest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mlp_top_debug_memtest.tcl
