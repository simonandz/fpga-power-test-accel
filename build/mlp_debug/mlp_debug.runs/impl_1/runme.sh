...
HD_PWD='R:/fpga/fpga-power-test-accel/build/mlp_debug/mlp_debug.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_top_debug_memtest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mlp_top_debug_memtest.tcl -notrace
