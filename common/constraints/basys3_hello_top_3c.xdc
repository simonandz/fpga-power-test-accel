...
set_property PACKAGE_PIN V19         [get_ports {led_blink2}]    ;# LD3
set_property IOSTANDARD LVCMOS33     [get_ports {led_blink2}]
set_property DRIVE 8                 [get_ports {led_blink2}]
set_property SLEW SLOW               [get_ports {led_blink2}]
