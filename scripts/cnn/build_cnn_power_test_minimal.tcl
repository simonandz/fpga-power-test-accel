# CNN Power Measurement Build Script - MINIMAL VERSION
# Generates bitstream with minimal I/O (1 LED only) for cleaner power measurement
#
# Controls on board:
...
set build_dir      [file normalize [file join $repo_root build cnn_power_test_minimal]]
set rpt_dir        [file normalize [file join $repo_root reports cnn_power_test_minimal]]

set part xc7a35tcpg236-1
set top cnn_power_test_wrapper_minimal

puts "============================================"
puts "CNN Power Measurement Build - MINIMAL"
puts "============================================"
...
create_project cnn_power_test_minimal $build_dir -part $part -force
...
set xdc_file [file join $constr_dir basys3_cnn_power_test_minimal.xdc]
...
set bit_src [file join $build_dir cnn_power_test_minimal.runs impl_1 ${top}.bit]
...
puts "=========================================="
puts ""
puts "Bitstream: build/cnn_power_test_minimal/${top}.bit"
puts ""
puts "============================================"
puts "POWER MEASUREMENT INSTRUCTIONS"
puts "============================================"
puts ""
puts "This is the MINIMAL version with only 1 LED."
puts "All other LEDs and 7-segment display are disabled."
puts ""
puts "Board Controls:"
...
puts ""
puts "  IDLE: SW1=0, LD0 blinks slowly"
puts "  ACTIVE: SW1=1, LD0 blinks fast"
puts ""
puts "============================================"
