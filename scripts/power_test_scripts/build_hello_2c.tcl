# ===== Build: hello_top_2c (Basys-3) =====

# --- Robust repo root resolution ---
set script_dir [file normalize [file dirname [info script]]]
set cand1      [file dirname $script_dir]          ;# .../scripts
set cand2      [file dirname $cand1]               ;# repo root candidate

# Optional override: vivado ... -tclargs R:/fpga/fpga-power-test-accel
if {[llength $::argv] >= 1} {
  set repo_root [file normalize [lindex $::argv 0]]
} else {
  # Auto-detect: prefer the first candidate that has common/rtl
  if {[file isdirectory [file join $cand1 common rtl]]} {
    set repo_root $cand1
  } elseif {[file isdirectory [file join $cand2 common rtl]]} {
    set repo_root $cand2
  } else {
    # Fallback to grandparent; will error later if wrong
    set repo_root $cand2
  }
}
...
# Show what XDCs exist and verify the chosen one
