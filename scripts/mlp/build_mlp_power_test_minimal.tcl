# MLP Power Measurement Build Script - MINIMAL VERSION
...
set build_dir      [file normalize [file join $repo_root build mlp_power_test_minimal]]
set rpt_dir        [file normalize [file join $repo_root reports mlp_power_test_minimal]]

set part xc7a35tcpg236-1
set top mlp_power_test_wrapper_minimal

puts "============================================"
puts "MLP Power Measurement Build - MINIMAL"
puts "============================================"
...
create_project mlp_power_test_minimal $build_dir -part $part -force
...
set xdc_file [file join $constr_dir basys3_mlp_power_test_minimal.xdc]
...
set bit_src [file join $build_dir mlp_power_test_minimal.runs impl_1 ${top}.bit]
...
puts "=========================================="
puts ""
puts "Bitstream: build/mlp_power_test_minimal/${top}.bit"
puts ""
puts "============================================"
